...
$string['block_user_delegation_co_role'] = 'Course Owner Role';
$string['block_user_delegation_co_role_desc'] = 'The course owner has the delegation of enrol and users creation for the courses e owns.';
...
$string['configcsvseparator'] = 'Separator of fields in csv file';
$string['configdelegationownerrole'] = 'The role that will be used to assign fellow ownership. this role must have the "isbehaslfof" capability allowed.';
...
$string['configuseadvancedform'] = 'Let enter much more user options if enabled';
...
$string['delegationownerrole'] = 'Role for user ownership';
...
$string['useadvancedform'] = 'Use advanced user form';
...
$string['useuserquota'] = 'Use user quota';
