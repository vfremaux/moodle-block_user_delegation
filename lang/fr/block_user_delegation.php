...
$string['block_user_delegation_co_role'] = 'Role pour la propriété du cours';
$string['block_user_delegation_co_role_desc'] = '';
...
$string['configcsvseparator'] = 'Caractère séparateur des champs dans le fichier CSV';
...
$string['configlastownerdeletes'] = 'Si activé, le dernier superviseur désactive le compte de l\'utilisateur qu\'il récuse.';
$string['configuseadvancedform'] = 'Le formulaire avancé permet de configurer beaucoup plus d\'options ';
...
$string['noassign'] = '-- Pas d\'assignation au cours --';
...
$string['useadvancedform'] = 'Formulaire utilisateur avancé';
...
$string['useuserquota'] = 'Utiliser les quotas utilisateur';
