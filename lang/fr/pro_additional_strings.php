...
require_once($CFG->dirroot.'/blocks/user_delegation/lib.php'); // to get xx_supports_feature();
if ('pro' == block_user_delegation_supports_feature()) {
    include($CFG->dirroot.'/blocks/user_delegation/pro/lang/fr/pro.php');
}
