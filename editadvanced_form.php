<?php //$Id: editadvanced_form.php,v 1.1 2012-03-01 08:09:17 vf Exp $
...
class user_editadvanced_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('hidden','power_uid',$USER->id);
        
        $mform->addElement('header', 'info', 'Othr Information'); 
        $mform->addElement('html','<div style="display:none;" id="exisiting_users"></div>');        
