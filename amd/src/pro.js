...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var blockuserdelegationpro = {
        ...
        check_product_key: function() {
            ...
            var validicon = ' <img class="icon" src="' + cfg.wwwroot + '/pix/i/valid.png' + '">';
            var cautionicon = ' <img class="icon" src="' + cfg.wwwroot + '/pix/i/warning.png' + '">';
            var invalidicon = ' <img class="icon" src="' + cfg.wwwroot + '/pix/i/invalid.png' + '">';
            var waiticon = ' <img class="icon" src="' + cfg.wwwroot + '/pix/i/ajaxloader.gif' + '">';
