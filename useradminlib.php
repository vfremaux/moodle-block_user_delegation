...
function useradmin_has_capabilities_to_edit() {
    ...
    &&  has_capability('moodle/user:editprofile', context_system::instance())) {
        return true;
    } else {
        return false;
    }
...
function useradmin_require_capabilities_to_edit() {
    ...
    require_capability('moodle/user:update', context_system::instance(), $USER->id);
    require_capability('moodle/user:editprofile', context_system::instance(), $USER->id);
}
...
function useradmin_require_capabilities_to_delete() {
    ...
    require_capability('moodle/user:delete', context_system::instance(), $USER->id);
}
...
function useradmin_require_capabilities_to_assign() {
    global $USER;
    require_capability('moodle/role:assign', context_system::instance(), $USER->id);
}
...
function useradmin_get_users_notemailstop() {
    ...
    $users = $DB->get_records_select('user', $select, 'lastname, firstname');
    return $users;
}
